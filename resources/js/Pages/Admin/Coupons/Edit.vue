<template>
    <AdminLayout :title="`Edit: ${coupon.code}`" subtitle="Update coupon details">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input v-model="form.code" type="text" class="input font-mono uppercase" :class="{'border-red-400': errors.code}" />
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input v-model="form.value" type="number" step="0.01" min="0" class="input pl-8" :class="{'border-red-400': errors.value}" />
                                </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input v-model="form.minimum_order_amount" type="number" step="0.01" min="0" class="input" />
                            </div>
                            <div>
                                <label class="label">Max Discount (৳)</label>
                                <input v-model="form.maximum_discount" type="number" step="0.01" min="0" class="input" :disabled="form.type === 'fixed'" />
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 rounded-xl p-4">
                            <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Usage Statistics</p>
                            <p class="text-sm text-gray-700">Used <strong>{{ coupon.used_count }}</strong> times
                                <span v-if="coupon.usage_limit"> out of {{ coupon.usage_limit }}</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl p-5 text-white">
                        <p class="text-xs font-semibold opacity-70 uppercase tracking-wide mb-2">Preview</p>
