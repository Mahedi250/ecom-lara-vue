<template>
    <AdminLayout title="Brands" subtitle="Manage product brands">
        <template #header-actions>
            <Link :href="route('admin.brands.create')" class="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold px-4 py-2 rounded-xl transition">
